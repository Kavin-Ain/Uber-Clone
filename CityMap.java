...
public class CityMap
{
  ...
  public static int getCityZone(String address){
    if (!validAddress(address)){
      //Create a condition when address is not valid
      return -1;
    }

    //If address is valid, do the following to check for zone number
    else{
      //use getCityBlock method to get both parts of address
      int[] cityBlock = getCityBlock(address);

      //Zone 0: Avenue = 1st-5th avenue, Street = 6th-9th street
      if (cityBlock[0] > 5 && cityBlock[1] < 6){
        return 0;
      }
      //Zone 1: Avenue = 6th-9th avenue, Street = 6th-9th street
      else if (cityBlock[0] > 5 && cityBlock[1] > 5){
        return 1;
      }
      //Zone 2: Avenue = 6th-9th avenue, Street = 1st-5th street
      else if (cityBlock[0] < 6 && cityBlock[1] > 5){
        return 2;
      }
      //Zone 3: Avenue = 1st-5th avenue, Street = 1st-5th street
      else{
        return 3;
      }
